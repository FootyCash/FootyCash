...
void BitcoinGUI::createActions()
{
    ...
    toggleHideAction = new QAction(QIcon(":/icons/FootyCash"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/FootyCash_testnet"));
            setWindowIcon(QIcon(":icons/FootyCash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/FootyCash_testnet"));
#endif
            if(trayIcon)
            {
