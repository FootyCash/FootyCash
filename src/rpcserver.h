...
extern json_spirit::Value listexterioraddresses(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listinterioraddresses(const json_spirit::Array& params, bool fHelp);
